    ...
    return (
        <View className="relative mt-4 rounded-lg shadow-xl transition hover:shadow-lg">
            ...
            <View className='bg-white w-80 h-auto p-2'>
                <Text className="mt-0.5 text-start font-extralight whitespace-nowrap text-lg italic text-[black]">{props.name}</Text>
                <View className="mt w-full h-full text-sm flex justify-between text-black">
